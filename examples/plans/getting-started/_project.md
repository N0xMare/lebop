...
2. (Optional) Tweak titles, labels, priorities, and bodies to match a real
   initiative.
3. `lebop plan validate examples/plans/getting-started`
4. `lebop plan apply examples/plans/getting-started --dry-run`
5. `lebop plan apply examples/plans/getting-started`
